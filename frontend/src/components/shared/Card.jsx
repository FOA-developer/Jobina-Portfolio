...
const Card = ({ tags = [], title, src, description, period, link = '#' }) => (
  <Link to={link}>
    <article
      className="flex flex-col justify-between rounded-2xl  transition-shadow duration-200 hover:shadow-md"
      style={{
        background:   '#ffffff',
    ...
    <div className="flex flex-col gap-4">
      <img src={src} alt={title} className="w-full h-auto rounded-t-lg" />
