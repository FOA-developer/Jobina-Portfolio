...
const First = ({tags, title, header, period,  description, link, img, impact }) => {
   return (
    <section className="">
      <div className="flex flex-col relative justify-between items-start overflow-hidden ">
        ...
        <div className="relative z-10 flex flex-col gap-4 justfy-between px-[10%] py-16">
          <h4 className="text-xs md:text-sm text-text-main mt-20 tracking-[0.2em] uppercase text-left ">flagship programme</h4>
