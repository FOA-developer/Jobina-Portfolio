  ...
  return  (
    ...
    <Navbar />
      ...
      <Second
        ...
        cert={["Supported 30+ digital skills and employability programmes across high sectors.", "Helped secure strategic partnerships.", "Supported expansion of Edo State's digital workforce ecosystem via partnerships.", "Strengthened Edo Innovates faculty governance, instructional and program systems." ]}
      />
      <Gallery 
           img={img2}
           img2={img6}
