...
import img from "../assets/Edobest/1.jpeg"
import img2 from "../assets/Edobest/2.jpeg"
import img4 from "../assets/Edobest/4.jpeg"
import img5 from "../assets/Edobest/3.jpeg"
import img1 from "../assets/Edobest/5.jpeg"
import img6 from "../assets/Edobest/6.jpeg"
  ...
  return  (
    ...
    <Navbar />
      ...
      <Second
        ...
        cert={["Supported 30+ digital skills and employability programmes across high-demand sectors.", "Helped secure 23 strategic partnerships, surpassing the 20-partnership target.", "Supported expansion of Edo State's digital workforce ecosystem via partnerships.", "Strengthened Edo Innovates faculty governance, instructional and program systems." ]}
      />
      <Gallery 
           img={img2}
           img2={img6}
